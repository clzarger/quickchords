...
// CHORDS ON PAPER (PDF) works
window.chords = function () {
    var filename = 'Chords on Paper';
    // <!---inputs-->
...
window.slides = function () {
  ...
  //Title Slide
    if (isNaN(title1)) {
      ...
      var pptxTitle1 = pptx.addNewSlide({ bkgd: '000000' });
      pptxTitle1.addText("Title", {x: 1.25, y: 3.5, font_size: 40, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'middle'});
    }
  //Slide One
    if (slideTwoStart1>0) {
    var pptxOne1 = pptx.addNewSlide({ bkgd: '000000' });
    pptxOne1.addText(slideOne1, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Two
    if (slideThreeStart1>0) {
    var pptxTwo1 = pptx.addNewSlide({ bkgd: '000000' });
    pptxTwo1.addText(slideTwo1, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Three
    if (slideFourStart1>0) {
    var pptxThree1 = pptx.addNewSlide({ bkgd: '000000' });
    pptxThree1.addText(slideThree1, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Four
    if (slideFiveStart1>0) {
    var pptxFour1 = pptx.addNewSlide({ bkgd: '000000' });
    pptxFour1.addText(slideFour1, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Five
    if (slideSixStart1>0) {
    var pptxFive1 = pptx.addNewSlide({ bkgd: '000000' });
    pptxFive1.addText(slideFive1, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Six
    if (slideSevenStart1>0) {
    var pptxSix1 = pptx.addNewSlide({ bkgd: '000000' });
    pptxSix1.addText(slideSix1, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Seven
    if (slideEightStart1>0) {
    var pptxSeven1 = pptx.addNewSlide({ bkgd: '000000' });
    pptxSeven1.addText(slideSeven1, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Eight
    if (slideNineStart1>0) {
    var pptxEight1 = pptx.addNewSlide({ bkgd: '000000' });
    pptxEight1.addText(slideEight1, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Nine
    if (slideTenStart1>0) {
    var pptxNine1 = pptx.addNewSlide({ bkgd: '000000' });
    pptxNine1.addText(slideNine1, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Ten
    if (slideElevenStart1>0) {
    var pptxTen1 = pptx.addNewSlide({ bkgd: '000000' });
    pptxTen1.addText(slideTen1, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Eleven
    if (slideTwelveStart1>0) {
    var pptxEleven1 = pptx.addNewSlide({ bkgd: '000000' });
    pptxEleven1.addText(slideEleven1, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Twelve
    if (slideThirteenStart1>0) {
    var pptxTwelve1 = pptx.addNewSlide({ bkgd: '000000' });
    pptxTwelve1.addText(slideTwelve1, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  ...
  //Slide One
    ...
    pptxOne2.addText(slideOne2, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Two
    if (slideThreeStart2>0) {
    var pptxTwo2 = pptx.addNewSlide({ bkgd: '000000' });
    pptxTwo2.addText(slideTwo2, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Three
    if (slideFourStart2>0) {
    var pptxThree2 = pptx.addNewSlide({ bkgd: '000000' });
    pptxThree2.addText(slideThree2, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Four
    if (slideFiveStart2>0) {
    var pptxFour2 = pptx.addNewSlide({ bkgd: '000000' });
    pptxFour2.addText(slideFour2, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
  }
  //Slide Five
    if (slideSixStart2>0) {
    var pptxFive2 = pptx.addNewSlide({ bkgd: '000000' });
    pptxFive2.addText(slideFive2, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Six
    if (slideSevenStart2>0) {
    var pptxSix2 = pptx.addNewSlide({ bkgd: '000000' });
    pptxSix2.addText(slideSix2, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Seven
    if (slideEightStart2>0) {
    var pptxSeven2 = pptx.addNewSlide({ bkgd: '000000' });
    pptxSeven2.addText(slideSeven2, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Eight
    if (slideNineStart2>0) {
    var pptxEight2 = pptx.addNewSlide({ bkgd: '000000' });
    pptxEight2.addText(slideEight2, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Nine
    if (slideTenStart2>0) {
    var pptxNine2 = pptx.addNewSlide({ bkgd: '000000' });
    pptxNine2.addText(slideNine2, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Ten
    if (slideElevenStart2>0) {
    var pptxTen2 = pptx.addNewSlide({ bkgd: '000000' });
    pptxTen2.addText(slideTen2, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Eleven
    if (slideTwelveStart2>0) {
    var pptxEleven2 = pptx.addNewSlide({ bkgd: '000000' });
    pptxEleven2.addText(slideEleven2, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Twelve
    if (slideThirteenStart2>0) {
    var pptxTwelve2 = pptx.addNewSlide({ bkgd: '000000' });
    pptxTwelve2.addText(slideTwelve2, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  ...
  //Slide One
    ...
    pptxOne3.addText(slideOne3, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Two
    if (slideThreeStart3>0) {
    var pptxTwo3 = pptx.addNewSlide({ bkgd: '000000' });
    pptxTwo3.addText(slideTwo3, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Three
    if (slideFourStart3>0) {
    var pptxThree3 = pptx.addNewSlide({ bkgd: '000000' });
    pptxThree3.addText(slideThree3, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Four
    if (slideFiveStart3>0) {
    var pptxFour3 = pptx.addNewSlide({ bkgd: '000000' });
    pptxFour3.addText(slideFour3, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Five
    if (slideSixStart3>0) {
    var pptxFive3 = pptx.addNewSlide({ bkgd: '000000' });
    pptxFive3.addText(slideFive3, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Six
    if (slideSevenStart3>0) {
    var pptxSix3 = pptx.addNewSlide({ bkgd: '000000' });
    pptxSix3.addText(slideSix3, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Seven
    if (slideEightStart3>0) {
    var pptxSeven3 = pptx.addNewSlide({ bkgd: '000000' });
    pptxSeven3.addText(slideSeven3, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Eight
    if (slideNineStart3>0) {
    var pptxEight3 = pptx.addNewSlide({ bkgd: '000000' });
    pptxEight3.addText(slideEight3, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Nine
    if (slideTenStart3>0) {
    var pptxNine3 = pptx.addNewSlide({ bkgd: '000000' });
    pptxNine3.addText(slideNine3, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Ten
    if (slideElevenStart3>0) {
    var pptxTen3 = pptx.addNewSlide({ bkgd: '000000' });
    pptxTen3.addText(slideTen3, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Eleven
    if (slideTwelveStart3>0) {
    var pptxEleven3 = pptx.addNewSlide({ bkgd: '000000' });
    pptxEleven3.addText(slideEleven3, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }
  //Slide Twelve
    if (slideThirteenStart3>0) {
    var pptxTwelve3 = pptx.addNewSlide({ bkgd: '000000' });
    pptxTwelve3.addText(slideTwelve3, {x: 1.25, y: '0%', font_size: 30, font_face: 'Helvetica', color: 'ffffff', align: 'center', valign: 'top'});
    }

    pptx.save('Lyrics on Slides');
...
window.handout = function () {
    ...
    doc.moveDown();
    doc.fontSize (11);
    doc.text(slideEleven1, {
      align: 'left',
      columns: 2,
    });
    doc.moveDown();
    doc.fontSize (11);
    doc.text(slideTwelve1, {
      align: 'left',
      columns: 2,
    });
    ...
    doc.moveDown();
    doc.fontSize (11);
    doc.text(slideEleven2, {
      align: 'left',
      columns: 2,
    });
    doc.moveDown();
    doc.fontSize (11);
    doc.text(slideTwelve2, {
      align: 'left',
      columns: 2,
    });
    // SONG ONE
    ...
    doc.moveDown();
    doc.fontSize (11);
    doc.text(slideEleven3, {
      align: 'left',
      columns: 2,
    });
    doc.moveDown();
    doc.fontSize (11);
    doc.text(slideTwelve3, {
      align: 'left',
      columns: 2,
    });
